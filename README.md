...
- The F# project is added to the solution file generated by Unity, so that Intellisense works in IDEs (tested with Visual Studio Code)


## Caveats
- Does not apply any scripting defines yet (TODO)
- Always builds in Debug mode for now (TODO)
